    ...
    <div class="container">
      <div class="flex gap-6">
        ...
        <main class="flex-1 min-w-0">
          ...
          <div v-if="activeTab === 'certs'">
            ...
            <div v-else-if="wallet.assets.length" class="grid gap-4">
              <div v-for="asset in wallet.assets" :key="asset.vc_id"
                ...
                <RouterLink :to="`/verify?id=${asset.vc_id}`" class="btn btn-outline btn-sm shrink-0">검증 →</RouterLink>
              </div>
            </div>
          ...
          <div v-else-if="activeTab === 'issue'"><IssueView /></div>
          <div v-else-if="activeTab === 'market'"><MarketView /></div>
